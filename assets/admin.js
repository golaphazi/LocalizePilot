(function(){
    ...
    document.querySelectorAll('.nt-reveal-key').forEach(function(button){button.addEventListener('click',function(){var input=button.parentNode.querySelector('input');var show=input.type==='password';input.type=show?'text':'password';button.textContent=show?nextTranslateAdmin.hide:nextTranslateAdmin.show;});});
    ...
    if(testButton){testButton.addEventListener('click',function(){
        ...
        testButton.disabled=true;testButton.textContent=nextTranslateAdmin.testing;result.textContent='';result.className='';
        var form=new FormData();
        form.append('action','next_translate_test_api');
        form.append('nonce',nextTranslateAdmin.nonce);
    ...
    document.querySelectorAll('.nt-copy-code').forEach(function(button){
        button.addEventListener('click',function(){
            ...
            var complete=function(){
                ...
                button.textContent=(window.nextTranslateAdmin&&nextTranslateAdmin.copied)?nextTranslateAdmin.copied:'Copied';
