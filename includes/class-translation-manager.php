...
final class Translation_Manager {
	...
	public function register_post_type(): void {
		$labels = array(
			'name'               => __( 'Translations', 'localizepilot' ),
			'singular_name'      => __( 'Translation', 'localizepilot' ),
			'menu_name'          => __( 'Translations', 'localizepilot' ),
			'add_new'            => __( 'Add Translation', 'localizepilot' ),
			'add_new_item'       => __( 'Add Translation', 'localizepilot' ),
			'edit_item'          => __( 'Edit Translation', 'localizepilot' ),
			'new_item'           => __( 'New Translation', 'localizepilot' ),
			'view_item'          => __( 'View Translation', 'localizepilot' ),
			'search_items'       => __( 'Search Translations', 'localizepilot' ),
			'not_found'          => __( 'No translations found.', 'localizepilot' ),
			'not_found_in_trash' => __( 'No translations found in Trash.', 'localizepilot' ),
		);
	...
	public function refresh_translation_action(): void {
		$translation_id = absint( $_GET['translation_id'] ?? 0 );
	...
	private function sync_translation_files( int $translation_id ): void {
		...
		$cache = new File_Cache( Plugin::instance()->get_settings() );
		$rendered = do_blocks( $translation->post_content );
